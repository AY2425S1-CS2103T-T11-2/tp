...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to sort the students based on their proficiency.")])]),_v(" "),_c('li',[_c('p',[_v("User enters the sort command.")])]),_v(" "),_c('li',[_c('p',[_v("KonTActs returns the list of students in the sorted order.")]),_v(" "),_c('p',[_v("Use case ends.")]),_v(" "),_c('br')])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User must have permission to write to the provided path.")]),_v(" "),_c('li',[_v("User must have enough storage to store the output file.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to export the contact list.")])]),_v(" "),_c('li',[_c('p',[_v("User provides the file path.")])]),_v(" "),_c('li',[_c('p',[_v("KonTActs exports the contact list in CSV format and shows the number of people successfully exported.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. User enters an invalid path (e.g .pdf).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. KonTActs displays an error message and request for user to provide a valid file path (e.g. must end with .csv)")])]),_v(" "),_c('li',[_c('p',[_v("2a2. User provides new file path")])]),_v(" "),_c('li',[_c('p',[_v("Step 2a1-2a2 are repeated until file path is valid")]),_v(" "),_c('p',[_v("Use case resumes from step 3.")]),_v(" "),_c('br')])])])])}
},function anonymous(
) {
with(this){return _c('div',{staticClass:"d-print-none"},[_c('hr')])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. KonTActs detects an error in the entered data.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. KonTActs displays error message.")])]),_v(" "),_c('li',[_c('p',[_v("3a2. User enters new data.")])]),_v(" "),_c('li',[_c('p',[_v("Steps 3a1-3a2 are repeated until the data entered are correct.")]),_v(" "),_c('p',[_v("Use case resumes from step 4.")]),_v(" "),_c('br')])])])])}
},function anonymous(
) {
with(this){return _c('div',{staticClass:"d-print-none"},[_c('hr')])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC13 - Import contacts from CSV file")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Precondition")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The file is in CSV format and ends with .csv")]),_v(" "),_c('li',[_v("The file contains valid data of at least 1 person")]),_v(" "),_c('li',[_v("The header of the file is in a specific sequence\n(\"Name\",\"Email\",\"Telegram\",\"Tags\",\"Github\",\"Assignments\",\"WeeksPresent\")")]),_v(" "),_c('li',[_v("Current user have permissions to access and read the file")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to import the contact list.")])]),_v(" "),_c('li',[_c('p',[_v("User gives the desired file (by its path).")])]),_v(" "),_c('li',[_c('p',[_v("KonTActs import the contact list from the specified file path and shows successful import.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. KonTActs detects an unsupported, corrupted file or a file without the valid headers.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. KonTActs indicates it is unable to import from that file and gives a more specific error message.")])]),_v(" "),_c('li',[_c('p',[_v("2a2. User provides a new file path")])]),_v(" "),_c('li',[_c('p',[_v("Steps 2a1 - 2a2 are repeated until KonTActs is able to import contacts from the file.")]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. KonTActs detects invalid content in CSV file (e.g. Name/Email that does not comply with requirement,\nDuplicate names)")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. KonTActs indicates it is unable to import from that file and gives a more specific error message.")])]),_v(" "),_c('li',[_c('p',[_v("2b2. User provides a new file path or update their CSV file")])]),_v(" "),_c('li',[_c('p',[_v("Steps 2b1 - 2b2 are repeated until KonTActs is able to import contacts from the file.")]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("*a. At any time, User chooses to cancel the import.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("*a1. KonTActs stops the import.")]),_v(" "),_c('p',[_v("Use case ends.")]),_v(" "),_c('br')])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 7 Nov 2024, 22:56:25 GMT+8]")])])])}
}];
